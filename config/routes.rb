Pia::Application.routes.draw do
  ...
  patch '/sosna/solution/upload'     => 'sosna_solution#upload',     :as => :sosna_solution_upload
  post '/sosna/solution/upload_corr' => 'sosna_solution#upload_corr',:as => :sosna_solution_upload_corr
  get  '/sosna/solution/:id/down'  => 'sosna_solution#download',     :as => :sosna_solution_download
  get  '/sosna/solution/:id/down_corr'  => 'sosna_solution#download_corr',:as => :sosna_solution_download_corr
  ...
  get  '/sosna/solution/downall'   => 'sosna_solution#downall',      :as => :sosna_solution_down
#  get  '/sosna/solution(/:id)'     => 'sosna_solution#show',         :as => :sosna_solution
  ...
  patch '/sosna/problem/update'     => 'sosna_problem#update',       :as => :sosna_problem_update
  ...
  patch '/sosna/solver/update'   => 'sosna_solver#update',           :as => :sosna_solver_update
  ...
  patch '/sosna/school/update'  => 'sosna_school#update',            :as => :sosna_school_update
